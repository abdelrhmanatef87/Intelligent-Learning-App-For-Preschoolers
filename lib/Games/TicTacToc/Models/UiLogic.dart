import 'package:intelligent_learning/Games/TicTacToc/Models/TicTacToeLogic.dart';
...
class UI {
  ...
  void playWinningSound() {
    player.setAsset('assets/audio/game/tictactoc/winner.wav');
  ...
  void playDrawSound() {
    player.setAsset('assets/audio/game/tictactoc/draw.mpeg');
    player.setVolume(2.0);
    player.play();
    print(2);
  }
  ...
  void playLetterSound() {
    player.setAsset(UI.character == "X"
        ? 'assets/audio/game/tictactoc/note1.wav'
        : 'assets/audio/game/tictactoc/note2.wav');
    player.setVolume(2.0);
    player.play();
    print(3);
  }
